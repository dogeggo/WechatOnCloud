...
export function vncServerProfileFrameRate(profile: VncServerProfile | undefined): number | null {
  return VNC_SERVER_PROFILE_OPTIONS.find((item) => item.profile === profile)?.frameRate ?? null;
}
